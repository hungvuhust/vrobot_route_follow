...
Curvelink::Curvelink(const Row &r, const ssize_t indexOffset) noexcept {
  if (indexOffset < 0) {
    if (!r["id_curve_link"].isNull()) {
      idCurveLink_ =
          std::make_shared<int32_t>(r["id_curve_link"].as<int32_t>());
    }
    ...
    if (!r["control_point_1_x"].isNull()) {
      controlPoint1X_ =
          std::make_shared<float>(r["control_point_1_x"].as<float>());
    }
    if (!r["control_point_1_y"].isNull()) {
      controlPoint1Y_ =
          std::make_shared<float>(r["control_point_1_y"].as<float>());
    }
    if (!r["control_point_2_x"].isNull()) {
      controlPoint2X_ =
          std::make_shared<float>(r["control_point_2_x"].as<float>());
    }
    if (!r["control_point_2_y"].isNull()) {
      controlPoint2Y_ =
          std::make_shared<float>(r["control_point_2_y"].as<float>());
    }
    if (!r["map_id"].isNull()) {
...
Curvelink::Curvelink(
  ...
  if (!pMasqueradingVector[0].empty() &&
    ...
    if (!pJson[pMasqueradingVector[0]].isNull()) {
      idCurveLink_ = std::make_shared<int32_t>(
  ...
  if (!pMasqueradingVector[1].empty() &&
    ...
    if (!pJson[pMasqueradingVector[1]].isNull()) {
      idStart_ = std::make_shared<int32_t>(
  ...
  if (!pMasqueradingVector[2].empty() &&
    ...
    if (!pJson[pMasqueradingVector[2]].isNull()) {
      idEnd_ = std::make_shared<int32_t>(
  ...
  if (!pMasqueradingVector[3].empty() &&
    ...
    if (!pJson[pMasqueradingVector[3]].isNull()) {
      controlPoint1X_ =
          std::make_shared<float>(pJson[pMasqueradingVector[3]].asFloat());
    }
  }
  if (!pMasqueradingVector[4].empty() &&
    ...
    if (!pJson[pMasqueradingVector[4]].isNull()) {
      controlPoint1Y_ =
          std::make_shared<float>(pJson[pMasqueradingVector[4]].asFloat());
    }
  }
  if (!pMasqueradingVector[5].empty() &&
    ...
    if (!pJson[pMasqueradingVector[5]].isNull()) {
      controlPoint2X_ =
          std::make_shared<float>(pJson[pMasqueradingVector[5]].asFloat());
    }
  }
  if (!pMasqueradingVector[6].empty() &&
    ...
    if (!pJson[pMasqueradingVector[6]].isNull()) {
      controlPoint2Y_ =
          std::make_shared<float>(pJson[pMasqueradingVector[6]].asFloat());
    }
  }
  if (!pMasqueradingVector[7].empty() &&
    ...
    if (!pJson[pMasqueradingVector[7]].isNull()) {
      mapId_ = std::make_shared<int32_t>(
...
Curvelink::Curvelink(const Json::Value &pJson) noexcept(false) {
  if (pJson.isMember("id_curve_link")) {
    ...
    if (!pJson["id_curve_link"].isNull()) {
      idCurveLink_ =
          std::make_shared<int32_t>((int32_t)pJson["id_curve_link"].asInt64());
    }
  }
  if (pJson.isMember("id_start")) {
    ...
    if (!pJson["id_start"].isNull()) {
      idStart_ =
          std::make_shared<int32_t>((int32_t)pJson["id_start"].asInt64());
    }
  }
  ...
  if (pJson.isMember("control_point_1_x")) {
    ...
    if (!pJson["control_point_1_x"].isNull()) {
      controlPoint1X_ =
          std::make_shared<float>(pJson["control_point_1_x"].asFloat());
    }
  }
  if (pJson.isMember("control_point_1_y")) {
    ...
    if (!pJson["control_point_1_y"].isNull()) {
      controlPoint1Y_ =
          std::make_shared<float>(pJson["control_point_1_y"].asFloat());
    }
  }
  if (pJson.isMember("control_point_2_x")) {
    ...
    if (!pJson["control_point_2_x"].isNull()) {
      controlPoint2X_ =
          std::make_shared<float>(pJson["control_point_2_x"].asFloat());
    }
  }
  if (pJson.isMember("control_point_2_y")) {
    ...
    if (!pJson["control_point_2_y"].isNull()) {
      controlPoint2Y_ =
          std::make_shared<float>(pJson["control_point_2_y"].asFloat());
    }
  }
...
void Curvelink::updateByMasqueradedJson(
    const Json::Value              &pJson,
    const std::vector<std::string> &pMasqueradingVector) noexcept(false) {
  if (pMasqueradingVector.size() != 8) {
    LOG_ERROR << "Bad masquerading vector";
...
const std::vector<std::string> &Curvelink::insertColumns() noexcept {
  static const std::vector<std::string> inCols = {"id_start",
                                                  "id_end",
                                                  "control_point_1_x",
                                                  "control_point_1_y",
                                                  "control_point_2_x",
...
bool Curvelink::validateJsonForCreation(const Json::Value &pJson,
                                        std::string       &err) {
  if (pJson.isMember("id_curve_link")) {
    if (!validJsonOfField(0, "id_curve_link", pJson["id_curve_link"], err,
                          true))
      return false;
  }
  if (pJson.isMember("id_start")) {
  ...
  if (pJson.isMember("control_point_1_x")) {
    if (!validJsonOfField(3, "control_point_1_x", pJson["control_point_1_x"],
                          err, true))
      return false;
  } else {
  ...
  if (pJson.isMember("control_point_1_y")) {
    if (!validJsonOfField(4, "control_point_1_y", pJson["control_point_1_y"],
                          err, true))
      return false;
  } else {
  ...
  if (pJson.isMember("control_point_2_x")) {
    if (!validJsonOfField(5, "control_point_2_x", pJson["control_point_2_x"],
                          err, true))
      return false;
  } else {
  ...
  if (pJson.isMember("control_point_2_y")) {
    if (!validJsonOfField(6, "control_point_2_y", pJson["control_point_2_y"],
                          err, true))
      return false;
  } else {
...
bool Curvelink::validateMasqueradedJsonForCreation(
    const Json::Value              &pJson,
...
bool Curvelink::validateJsonForUpdate(const Json::Value &pJson,
                                      std::string       &err) {
  if (pJson.isMember("id_curve_link")) {
    if (!validJsonOfField(0, "id_curve_link", pJson["id_curve_link"], err,
                          false))
...
bool Curvelink::validateMasqueradedJsonForUpdate(
    const Json::Value              &pJson,
    const std::vector<std::string> &pMasqueradingVector, std::string &err) {
  if (pMasqueradingVector.size() != 8) {
    err = "Bad masquerading vector";
...
bool Curvelink::validJsonOfField(size_t index, const std::string &fieldName,
  ...
  case 7:
    ...
    break;
  default: err = "Internal error in the server"; return false;
  }
  return true;
}
